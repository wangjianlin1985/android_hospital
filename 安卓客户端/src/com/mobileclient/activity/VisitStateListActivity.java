...
import com.mobileclient.util.ActivityUtils;import com.mobileclient.util.VisitStateSimpleAdapter;
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new VisitStateSimpleAdapter(VisitStateListActivity.this, list,
	        					R.layout.visitstate_list_item,
	        					new String[] { "visitStateId","visitStateName" },
	        					new int[] { R.id.tv_visitStateId,R.id.tv_visitStateName,},lv);
