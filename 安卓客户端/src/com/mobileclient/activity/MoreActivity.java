...
public class MoreActivity extends Activity {
	private String[] strs = new String[]{"预约","时间段","出诊状态","留言","修改个人信息","关于"};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if(arg2 == 1){
					Intent intent  = new Intent(MoreActivity.this, TimeSlotListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 2){
					Intent intent  = new Intent(MoreActivity.this, VisitStateListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 3){
